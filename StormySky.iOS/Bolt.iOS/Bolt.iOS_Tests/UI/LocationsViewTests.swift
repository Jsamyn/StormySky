...
final class LocationsViewTests: XCTestCase {
    ...
    /**
     Validate locations list view
     */
    func testLocationsList() throws {
        
        /* Arrange */
        let locationList = try self.sub.inspect().find(viewWithAccessibilityIdentifier: "locations_list").forEach()

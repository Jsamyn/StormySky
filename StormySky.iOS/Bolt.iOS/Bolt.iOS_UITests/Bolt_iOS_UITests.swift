...
//        let titleTextExp = "Locations"
//        let addButtonImageExp = Image(systemName: "plus")
//        
//        /* Act */
//        let titleResult = try subject.inspect().find(viewWithAccessibilityIdentifier: "LocationTitle").text().string()
//        let locationListResult = try subject.inspect().find(viewWithAccessibilityIdentifier: "LocationList")
//        let addButtonResult = try subject.inspect().find(viewWithAccessibilityIdentifier: "AddButton")
//        let addButtonImageResult = try addButtonResult.image(0).actualImage()
//        
//        /* Assert */
//        XCTAssertEqual(titleResult, titleTextExp)
//        XCTAssertNotNil(addButtonResult)
//        XCTAssertEqual(addButtonImageResult, addButtonImageExp)
//    }
//}
